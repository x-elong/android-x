...
class UpdateApplication : Application{
    companion object {
        private var instance: UpdateApplication? = null

        fun getInstance(): UpdateApplication {
            if (null == instance) {
                instance = UpdateApplication()
            }
            return (instance as UpdateApplication)
        }
    }
    constructor(){}
    fun detectionUpdate(context: Context){
        //版本2升级测试
        /***** Beta高级设置 *****/
        /**
...
//Beta.upgradeDialogLayoutId = R.layout.upgrade_layout;
        ...
        /***** 统一初始化Bugly产品，包含Beta *****/
        Bugly.init(context, "16a06fe349", true)
    }
}